...
class Mochila {
    ...
    *
    * @param {String} type The name to be used for the collection.
    */
    addType(type) {
    ...
    */
    ...
    /**
    * The named collection will use the given factory to create new models.
    *
    ...
    */
    registerModelFactory(type, factory) {
        if (this._store[type] === void 0) {
