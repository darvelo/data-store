    ...
    */
    removeModels(name, models) {
        ...
        for (i = 0; i < models.length; ++i) {
            ...
            if (idx !== void 0) {
                deleted.push(modelType.splice(idx, 1)[0]);
            }
        }
